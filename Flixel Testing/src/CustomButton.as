package
{
	...
	public class CustomButton extends FlxSprite
	{
		[Embed(source = "../assets/sprites/buttontest.png")] private var ImgDefaultButton:Class
		 ...
		 */
		override public function CustomButton(X:Number=0,Y:Number=0,OnClick:Function=null)
		{
			super(X,Y);

			loadGraphic(ImgDefaultButton,true,false,120,40);
